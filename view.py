...
# # Configurar locale para formato europeu
...
#                 lambda x: f'R$ {locale.format_string("%.2f", x, grouping=True)}' if pd.notnull(x) else ''
#             )
...
#                 lambda x: locale.format_string("%.0f", x, grouping=True) if pd.notnull(x) else ''
#             )
